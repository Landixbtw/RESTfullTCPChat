...
public class View extends VBox {
    ...
    public View(Controller controller) {
        ...
        getChildren().addAll(infoLabel, fieldGuess, answer,/* btnInit,*/ btnGuess, btnNewGame);

        //Mein Zeug (Init Button entfernt, es wird initialisiert, sobald ein View-Objekt erzeugt wird,
        //also sobald das Fenster erscheint
        CompletableFuture<String> cf = controller.onInit(min, max);
        try {
            this.ref = (String) cf.get();
        } catch (InterruptedException ex) {
